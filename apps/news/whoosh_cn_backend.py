...
class ChineseTokenizer(Tokenizer):
    def __call__(self, value, positions=False, chars=False, keeporiginal=False, removestops=True, start_pos=0,
                 start_char=0, mode='', *args, **kwargs):
        t = Token(positions, value, removestops=removestops, mode=mode, **kwargs)
    ...
    def build_schema(self, fields):
        ...
        for field_name, field_class in fields.items():
            if field_class.is_multivalued:
                ...
                schema_fields[field_class.index_fieldname] = TEXT(stored=True, analyzer=ChinsesAnalyzer(),
